class CfgHints
{
	class Overview {
		...
		class Gamemode {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\mission_strategy.paa";
		};
		...
		class Task_Roster {
			...
			//image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\<cardname>.paa";
			//Note: No image
		};
		...
		class Gearing_Up {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\arsenal.paa";
		};
		...
		class Fast_Travel {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\map.paa";
		};
	...
	class Building {
		...
		class Overview {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\build_menu.paa";
		};
		...
		class Placing {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\ghost_building.paa";
		};
		...
		class Resupplying {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\decay.paa";
		};
		...
		class Bases {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\situation_room.paa";
		};
		...
		class Medical_Tent {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\medical_tent.paa";
		};
		...
		class Checkpoint {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\checkpoint.paa";
		};
	...
	class Deployment {
		...
		class Duty_Officer {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\duty_officer.paa";
		};
	};
	...
	class Environment {
		...
		class Snakes {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\snake.paa";
		};
		...
		class Night {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\FOB_flare.paa";
		};
	...
	class Gameplay {
		...
		class Respawning_Checkpoint {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\checkpoint_supplies.paa";
		};
		...
		class Needs {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\drink_food.paa";
		};
		...
		class Tasks {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\AA.paa";
		};
		...
		class Logistics {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\logistic_menu.paa";
		};
	...
	class Logistics {
		...
		class Supplies {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\supply_officer.paa";
		};
		...
		class Wrecks {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\wreck_packing.paa";
		};
	...
	class Team {
		...
		class Mike_Force {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\mike_force.paa";
		};
		...
		class Green_Hornets {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\green_hornet.paa";
		};
		...
		class CharliePlatoon {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\CharliePlatoon.paa";
		};
	...
	class Artillery {
		...
		class RTO {
			...
			image = "\vn\ui_f_vietnam\ui\AlphaPlatoon\survivalcards\arty_support.paa";
		};
