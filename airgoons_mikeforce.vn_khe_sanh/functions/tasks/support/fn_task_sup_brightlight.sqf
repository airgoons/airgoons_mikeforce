...
_taskDataStore setVariable ["find_aircrew", {
	...
	private _validRescueUnits = missionNamespace getVariable "charlieplatoon";
	...
	//This is a bit inefficient, loops (count units charlieplatoon) * (count UnitsToRescue) times.
