...
_dataStore setVariable ["INIT", {
	...
	private _task = ["secondary_st2", "", [["pos", _taskDataStore getVariable "aaPos"]], "", ["charlieplatoon"]] call vn_mf_fnc_task_create;
...
_dataStore setVariable ["BEFORE_STATES_RUN", {
	...
	private _validPlayers = _playersInArea select {vehicle _x isEqualTo _x && _x getVariable ["vn_mf_db_player_group", "FAILED"] == "charlieplatoon"};
